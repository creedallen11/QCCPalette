...
import org.netbeans.modules.javasourcefilepalette.items.ReadConsole;
...
public class ReadConsolePopup extends javax.swing.JPanel {
    ...
    public boolean showDialog() {
        ...
        String displayName = "";
        try {
            displayName = NbBundle.getBundle("org.netbeans.modules.javasourcefilepalette.items.resources.Bundle").getString("NAME_html-readConsole");
        } catch (Exception e) {
        }
        ...
        if (gbu.getSelectedButtonText(buttonGroup1) != null && !varNameCombo1.getText().equals("")) {
            ...
            try {
                ...
                if (cvn.isGood(varName)) {
                    ...
                    sb.append("//  open up standard input\n\t");
                    sb.append("BufferedReader br = new BufferedReader(new InputStreamReader(System.in));\n\t");
                    sb.append("String ").append(varName).append(";\n\t");
                    sb.append("//  readLine() method\n\n\t");
                    sb.append("try {\n\t\t");
                    sb.append(varName);
