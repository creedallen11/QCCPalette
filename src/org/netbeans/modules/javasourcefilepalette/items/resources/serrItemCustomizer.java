...
import org.netbeans.modules.javasourcefilepalette.items.serr;
...
public class serrItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public serrItemCustomizer(serr item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.javasourcefilepalette.items.resources.Bundle").getString("NAME_html-serr");
        } catch (Exception e) {}
