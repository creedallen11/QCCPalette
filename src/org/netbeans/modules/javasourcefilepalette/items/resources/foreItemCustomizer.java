...
import org.netbeans.modules.javasourcefilepalette.items.fore;
...
public class foreItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public foreItemCustomizer(fore item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.javasourcefilepalette.items.resources.Bundle").getString("NAME_html-fore");
        } catch (Exception e) {}
