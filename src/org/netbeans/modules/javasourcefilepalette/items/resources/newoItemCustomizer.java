...
import org.netbeans.modules.javasourcefilepalette.items.newo;
...
public class newoItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public newoItemCustomizer(newo item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.javasourcefilepalette.items.resources.Bundle").getString("NAME_html-newo");
        } catch (Exception e) {}
