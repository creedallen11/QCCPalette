...
import org.netbeans.modules.javasourcefilepalette.items.forc;
...
public class forcItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public forcItemCustomizer(forc item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.javasourcefilepalette.items.resources.Bundle").getString("NAME_html-forc");
        } catch (Exception e) {}
