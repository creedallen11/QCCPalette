...
import org.netbeans.modules.javasourcefilepalette.items.sout;
...
public class soutItemCustomizer extends javax.swing.JPanel {
     ...
     * @param target
     */
    public soutItemCustomizer(sout item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    }
    ...
    public boolean showDialog() {
        ...
        try {
            displayName = NbBundle.getBundle(
                "org.netbeans.modules.javasourcefilepalette.items.resources.Bundle").getString("NAME_html-sout");
        } catch (Exception e) {}
